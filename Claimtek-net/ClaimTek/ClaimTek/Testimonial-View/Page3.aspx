<%@ Page Title="Testimonials &#8211; Page 3" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Page3.aspx.cs" Inherits="ClaimTek.Testimonial_View.Page3" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><a href="Page1.aspx" class="cherry-breadcrumbs_item_link" rel="tag" title="Testimonials">Testimonials</a></div>
                                    <div class="cherry-breadcrumbs_item">
                                        <div class="cherry-breadcrumbs_item_sep">|</div>
                                    </div>
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Testimonials</span></div>
                                    <div class="cherry-breadcrumbs_item">
                                        <div class="cherry-breadcrumbs_item_sep">|</div>
                                    </div>
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Page 3</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main" role="main">
                        <div class="testimonials-wrap template-page testimonials-page testimonials-page_archive">
                            <div class="testimonials-list">
                                <div id="quote-5052" class="testimonials-item item-1 odd clearfix">
                                    <blockquote>
                                        <p>
                                            <iframe width="1170" height="658" src="https://www.youtube.com/embed/HpjKnV2CefY?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                        </p>
                                        <h3>Medical Group CEO: Starting A Medical Billing Business With ClaimTek</h3>
                                        <span class="fa fa-comment-o cherry-icon   icon-194"></span>
                                        <p>If I was to start all over again, I would not hesitate to look into ClaimTek</p>
                                        <footer><cite class="author" title="Carlos Escobar">Carlos Escobar</cite></footer>
                                    </blockquote>
                                </div>
                                <div id="quote-5037" class="testimonials-item item-2 even clearfix">
                                    <blockquote>
                                        <p>
                                            <iframe width="1170" height="878" src="https://www.youtube.com/embed/g12cqkDFGmM?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                        </p>
                                        <h3>My Experience in Starting A Medical Billing Business with ClaimTek</h3>
                                        <span class="fa fa-comment-o cherry-icon   icon-660"></span>
                                        <p>ClaimTek Systems actually gave me everything I needed from day one as a business owner</p>
                                        <footer><cite class="author" title="Yemi Yekini">Yemi Yekini</cite></footer>
                                    </blockquote>
                                </div>
                                <div id="quote-5033" class="testimonials-item item-3 odd clearfix">
                                    <blockquote>
                                        <p>
                                            <iframe width="1170" height="658" src="https://www.youtube.com/embed/NBr5_wRIyOE?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                        </p>
                                        <h3>Nurse Practitioner Starting A Medical Billing Business With ClaimTek</h3>
                                        <span class="fa fa-comment-o cherry-icon   icon-229"></span>
                                        <p>Comparing Numerous practice management systems, I did find ClaimTek MedOffice was a good value and a good fit for our office</p>
                                        <footer><cite class="author" title="Leann Minotti">Leann Minotti</cite></footer>
                                    </blockquote>
                                </div>
                                <div id="quote-5030" class="testimonials-item item-4 even clearfix">
                                    <blockquote>
                                        <p>
                                            <iframe width="1170" height="658" src="https://www.youtube.com/embed/s_kqryi6pj8?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                        </p>
                                        <h3>Sabina Acquah: My Great Experience as a Client of ClaimTek Systems</h3>
                                        <footer><cite class="author" title="Sabina Acquah">Sabina Acquah</cite></footer>
                                    </blockquote>
                                </div>
                                <div id="quote-5026" class="testimonials-item item-5 odd clearfix">
                                    <blockquote>
                                        <p>
                                            <iframe width="1170" height="878" src="https://www.youtube.com/embed/uRN5RHtK8qM?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                        </p>
                                        <h3>ClaimTek Helped Me Succeed In Medical Billing</h3>
                                        <footer><cite class="author" title="Mary Pat Taylor">Mary Pat Taylor</cite></footer>
                                    </blockquote>
                                </div>
                                <div id="quote-5023" class="testimonials-item item-6 even clearfix">
                                    <blockquote>
                                        <p>
                                            <iframe width="1170" height="658" src="https://www.youtube.com/embed/OCxOrz6zENM?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                        </p>
                                        <h3>Corporate Level Medical Billing Using ClaimTek’s MedOffice</h3>
                                        <footer><cite class="author" title="Sy Zahedi">Sy Zahedi</cite></footer>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
                        <nav class="navigation pagination" role="navigation">
                            ...
                            <div class="nav-links">
                                <a class="prev page-numbers" href="Page2.aspx">Previous</a>
                                <a class='page-numbers' href='Page1.aspx'>1</a>
                                <a class='page-numbers' href='Page2.aspx'>2</a>
                                <a class='page-numbers current'>3</a>
                                <a class="next page-numbers" href="Page4.aspx">Next</a>
                                <a class="next page-numbers" href="Page5.aspx">5</a>
                            </div>
                        </nav>
                    </main>
                </div>
