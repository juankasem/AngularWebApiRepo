<%@ Page Title="Heather Beauford" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Heather_Beauford.aspx.cs" Inherits="ClaimTek.Testimonial_View.Heather_Beauford" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Heather Beauford</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="content-sidebar-wrapper">
                        <div id="primary" class="content-area">
                            <main id="main" class="site-main" role="main">
                                <article class="clearfix post-4998 testimonial type-testimonial status-publish hentry mpce-post-div" id="post-4998">
                                    <div class="testimonials-wrap template-single testimonials-page-single">
                                        <div class="testimonials-list">
                                            <div id="quote-4998" class="testimonials-item item-1 odd clearfix">
                                                <blockquote>
                                                    <p>
                                                        <iframe width="1170" height="658" src="https://www.youtube.com/embed/xQDMZnz54Ck?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                                    </p>
                                                    <h3>My Amazing Experience with ClaimTek, Training, Support &amp; MedOffice Software</h3>
                                                    <footer><cite class="author" title="Heather Beauford">Heather Beauford</cite></footer>
                                                </blockquote>
                                            </div>
                                        </div>
                                    </div>
