<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Terry_Mcnamara.aspx.cs" Inherits="ClaimTek.Testimonial_View.Terry_Mcnamara" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Terry Mcnamara</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-sidebar-wrapper">
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main" role="main">
                            <article class="clearfix post-4981 testimonial type-testimonial status-publish hentry mpce-post-div" id="post-4981">
                                <div class="testimonials-wrap template-single testimonials-page-single">
                                    <div class="testimonials-list">
                                        <div id="quote-4981" class="testimonials-item item-1 odd clearfix">
                                            <blockquote>
                                                <p>
                                                    <iframe width="1170" height="658" src="https://www.youtube.com/embed/AZ71gMG3QEo?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                                </p>
                                                <h3>How I Started A Career In Medical Billing From Home Using ClaimTek</h3>
                                                <footer><cite class="author" title="Terry Mcnamara">Terry Mcnamara</cite></footer>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
