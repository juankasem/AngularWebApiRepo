<%@ Page Title="Paul Triolo MD" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Paul_Triolo_MD.aspx.cs" Inherits="ClaimTek.Testimonial_View.Paul_Triolo_MD" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Paul Triolo MD</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-sidebar-wrapper">
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main" role="main">
                            <article class="clearfix post-5106 testimonial type-testimonial status-publish hentry mpce-post-div" id="post-5106">
                                <div class="testimonials-wrap template-single testimonials-page-single">
                                    <div class="testimonials-list">
                                        <div id="quote-5106" class="testimonials-item item-1 odd clearfix">
                                            <blockquote>
                                                <p>
                                                    <iframe width="1170" height="658" src="https://www.youtube.com/embed/wJqVrMgRFPU?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                                </p>
                                                <h3>A Doctor’s Story: MedOffice Is The Best Software For Medical Billing</h3>
                                                <span class="fa fa-comment-o cherry-icon   icon-137"></span>
                                                <p>ClaimTek was much better than the rest of the software out there. In terms of scalability , in terms of proficiency. they really did a great job.</p>
                                                <footer><cite class="author" title="Paul Triolo MD">Paul Triolo MD</cite></footer>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="cherry-sidebar-main sidebar-main widget-area" role="complementary">
                        <aside id="recent-posts-2" class="widget-no-mobile widget widget_recent_entries">
                            <h3 class="widget-title">Training</h3>
                            <ul>
                                <li>
                                    <a href="../Training/Training-One-On-One.aspx">Live &#038; Private One-On-One Training from the comfort of your home</a>
                                </li>
                                <li>
                                    <a href="../Training/Training-Stage-One.aspx">Training Stage One, Live Exercises</a>
                                </li>
                                <li>
                                    <a href="../Training/Training-Stage-Two.aspx">Training Stage Two, Be Prepared</a>
                                </li>
                                <li>
                                    <a href="../Training/Training-Stage-Three.aspx">Training Stage Three, We Team-Up With You</a>
                                </li>
                            </ul>
                        </aside>
                        <aside id="nav_menu-2" class="widget widget_nav_menu">
                            <div class="menu-footer-navigation-container">
                                <ul id="menu-footer-navigation" class="menu">
                                    <li id="menu-item-36" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-36"><a href="~/Home.aspx">Home</a></li>
                                    <li id="menu-item-59" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-59"><a href="~/IncomePotential.aspx">Potentials</a></li>
                                    <li id="menu-item-35" class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-35"><a href="~/Training.aspx">Training</a></li>
                                    <li id="menu-item-58" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-58"><a href="~/Contacts.aspx">Contacts</a></li>
                                </ul>
                            </div>
                        </aside>
                    </div>
