<%@ Page Title="David Waite" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="David_Waite.aspx.cs" Inherits="ClaimTek.Testimonial_View.David_Waite" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">David Waite</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-sidebar-wrapper">
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main" role="main">
                            <article class="clearfix post-5008 testimonial type-testimonial status-publish hentry mpce-post-div" id="post-5008">
                                <div class="testimonials-wrap template-single testimonials-page-single">
                                    <div class="testimonials-list">
                                        <div id="quote-5008" class="testimonials-item item-1 odd clearfix">
                                            <blockquote>
                                                <p>
                                                    <iframe width="1170" height="658" src="https://www.youtube.com/embed/oTUkyM5OIk4?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                                </p>
                                                <h3>How I Now Handle Over 100 Doctors&#8217; Billing Accounts With ClaimTek&#8217;s MedOffice Software</h3>
                                                <footer><cite class="author" title="David Waite">David Waite</cite></footer>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
