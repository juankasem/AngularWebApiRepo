<%@ Page Title="Maria Coleman" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Maria_Coleman.aspx.cs" Inherits="ClaimTek.Testimonial_View.Maria_Coleman" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Maria Coleman</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-sidebar-wrapper">
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main" role="main">
                            <article class="clearfix post-111 testimonial type-testimonial status-publish hentry mpce-post-div" id="post-111">
                                <div class="testimonials-wrap template-single testimonials-page-single">
                                    <div class="testimonials-list">
                                        <div id="quote-111" class="testimonials-item item-1 odd clearfix">
                                            <blockquote>
                                                <p>Maria Coleman</p>
                                                <p>
                                                    <iframe width="1170" height="658" src="https://www.youtube.com/embed/IIAdnVE2C5Y?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                                </p>
                                                <div id="watch7-headline" class="clearfix">
                                                    <div id="watch-headline-title">
                                                        <h3 class="watch-title-container"><span id="eow-title" class="watch-title" dir="ltr" title="Why I like ClaimTek and it's MedOffice Software!">Why I like ClaimTek and it&#8217;s MedOffice Software!</span></h3>
                                                    </div>
                                                </div>
                                                <footer><cite class="author" title="Maria Coleman">Maria Coleman</cite></footer>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <aside id="nav_menu-2" class="widget widget_nav_menu">
                            <div class="menu-footer-navigation-container">
                                <ul id="menu-footer-navigation" class="menu">
                                    ...
                                    <li id="menu-item-35" class="menu-item menu-item-type-post_type menu-item-object-page current_page_parent menu-item-35"><a href="../Trainingfull.aspx">Training</a></li>
