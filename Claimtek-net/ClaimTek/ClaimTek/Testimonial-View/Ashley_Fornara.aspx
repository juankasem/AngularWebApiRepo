<%@ Page Title="Ashley Fornara" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ashley_Fornara.aspx.cs" Inherits="ClaimTek.Testimonial_View.Ashley_Fornara" %>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="cherry-breadcrumbs_content">
                        <div class="cherry-breadcrumbs_wrap">
                            ...
                            <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Ashley Fornara</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-sidebar-wrapper">
                <div id="primary" class="content-area">
                    <main id="main" class="site-main" role="main">
                        <article class="clearfix post-5014 testimonial type-testimonial status-publish hentry mpce-post-div" id="post-5014">
                            <div class="testimonials-wrap template-single testimonials-page-single">
                                <div class="testimonials-list">
                                    <div id="quote-5014" class="testimonials-item item-1 odd clearfix">
                                        <blockquote>
                                            <p>
                                                <iframe width="1170" height="878" src="https://www.youtube.com/embed/Uj85H5x_y_8?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                            </p>
                                            <h3>Medical Billing Business Success Using ClaimTek’s MedOffice</h3>
                                            <footer><cite class="author" title="Ashley Fornara">Ashley Fornara</cite></footer>
                                        </blockquote>
                                    </div>
                                </div>
                            </div>
