<%@ Page Title="Zia Uddin" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Zia_Uddin.aspx.cs" Inherits="ClaimTek.Testimonial_View.Zia_Uddin" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Zia Uddin</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-sidebar-wrapper">
                    <div id="primary" class="content-area">
                        <main id="main" class="site-main" role="main">
                            <article class="clearfix post-4994 testimonial type-testimonial status-publish hentry mpce-post-div" id="post-4994">
                                <div class="testimonials-wrap template-single testimonials-page-single">
                                    <div class="testimonials-list">
                                        <div id="quote-4994" class="testimonials-item item-1 odd clearfix">
                                            <blockquote>
                                                <p>
                                                    <iframe width="1170" height="658" src="https://www.youtube.com/embed/yZnW57VYfo0?feature=oembed" frameborder="0" allowfullscreen></iframe>
                                                </p>
                                                <h3>My 7 Years in Medical Billing Using ClaimTek Training, Marketing and MedOffice Software</h3>
                                                <footer><cite class="author" title="Zia Uddin">Zia Uddin</cite></footer>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
