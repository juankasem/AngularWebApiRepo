<%@ Page Title="Training Stage Two, Be Prepared" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Training-Stage-Two.aspx.cs" Inherits="ClaimTek.Training.Training_Stage_Two" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="cherry-breadcrumbs_content">
                                <div class="cherry-breadcrumbs_wrap">
                                    ...
                                    <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Training Stage Two, Be Prepared</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div id="primary" class="content-area">
                    <main id="main" class="site-main" role="main">
                        <article class="clearfix post-21 post type-post status-publish format-standard has-post-thumbnail hentry category-training mpce-post-div" id="post-21">
                            ...
                            <div class="post-content">
                                ...
                                <header class="entry-header">
                                    <h2 class="entry-title">Training Stage Two, Be Prepared</h2>
                                </header>
                                ...
                                <figure class="entry-thumbnail cherry-thumb-l aligncenter large">
                                    <img width="1170" height="780" src="../Images/Training/shutterstock_192063251-1170x780.jpg" class="attachment-cherry-thumb-l size-cherry-thumb-l wp-post-image" alt="" />
                                </figure>
                                ...
                                <div class="entry-content">
                                    <div class="row row-edge  ">
                                        <div class="col-md-12">
                                            ...
                                            <blockquote>
                                                <p>We&#8217;ll Prepare You For Battle</p>
                                            </blockquote>
                                        </div>
                                    </div>
                                    <p>&nbsp;</p>
                                    <div class="row row-edge  ">
                                        <div class="col-md-12 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-0 col-xs-pull-0 col-sm-pull-0 col-md-pull-0 col-lg-pull-0 col-xs-push-0 col-sm-push-0 col-md-push-0 col-lg-push-0">
                                            <a class="cherry-btn cherry-btn-primary cherry-btn-medium cherry-btn-inline cherry-btn-fade  " target="_self" href="http://www.claimtek.com/Training/Default.aspx"><span class="fa fa-info-circle cherry-btn-icon icon-position-left icon-826"></span><span class="cherry-btn-content-wrap">See Full Details On Our Information Bank Website</span></a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="related-posts">
                            ...
                            <ul class="related-posts_list row list-unstyled">
                                ...
                                <li class="related-posts_item col-xs-12 col-sm-6 col-md-3">
                                    <figure class="entry-thumbnail cherry-thumb-s related-posts_thumbnail">
                                        <img width="200" height="150" src="../Images/Training/shutterstock_74656324-200x150.jpg" class="attachment-cherry-thumb-s size-cherry-thumb-s wp-post-image" alt="" />
                                    </figure>
