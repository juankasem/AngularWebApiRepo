<%@ Page Title="Live &#038; Private One-On-One Training from the comfort of your home" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Training-One-On-One.aspx.cs" Inherits="ClaimTek.Training.Training_One_On_One" %>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="cherry-breadcrumbs_content">
                        <div class="cherry-breadcrumbs_wrap">
                            ...
                            <div class="cherry-breadcrumbs_item"><span class="cherry-breadcrumbs_item_target">Live &#038; Private One-On-One Training from the comfort of your home</span></div>
                        </div>
                    </div>
                </div>
            </div
        ...
        <div class="container">
            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main" role="main">
                    <article class="clearfix post-22 post type-post status-publish format-standard has-post-thumbnail hentry category-training mpce-post-div" id="post-22">
                        ...
                        <div class="post-content">
                            ...
                            <header class="entry-header">
                                <h2 class="entry-title">Live &#038; Private One-On-One Training from the comfort of your home</h2>
                            </header>
                            ...
                            <figure class="entry-thumbnail cherry-thumb-l aligncenter large">
                                <img width="1170" height="780" src="../Images/Training/shutterstock_81253987-555-1170x780.jpg" class="attachment-cherry-thumb-l size-cherry-thumb-l wp-post-image" alt="" /></figure>

                            <div class="entry-content">
                                <div class="row row-edge  ">
                                    <div class="col-md-12">
                                        <h3>Professional Online One-On-One Training In The Comfort Of Your Home!</h3>
                                        ...
                                        <p>In addition to our extensive medical billing training material (manuals, audio, video &#8212; as detailed on the other tabs in this section), ClaimTek offers a completely personalized one-on-one medical billing training program.</p>
                                        <blockquote>
                                            <p>The training is divided into three stages</p>
                                        </blockquote>
                                    </div>
                                </div>
                                <p>&nbsp;</p>
                                <div class="row row-edge  ">
                                    <div class="col-md-12 col-xs-offset-0 col-sm-offset-0 col-md-offset-0 col-lg-offset-0 col-xs-pull-0 col-sm-pull-0 col-md-pull-0 col-lg-pull-0 col-xs-push-0 col-sm-push-0 col-md-push-0 col-lg-push-0">
                                        <a class="cherry-btn cherry-btn-primary cherry-btn-medium cherry-btn-inline cherry-btn-fade  " target="_self" href="http://www.claimtek.com/Training/Default.aspx">See Details On Our Information Bank Website</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ul class="related-posts_list row list-unstyled">
                            <li class="related-posts_item col-xs-12 col-sm-6 col-md-3">
                                <figure class="entry-thumbnail cherry-thumb-s related-posts_thumbnail">
                                    <img width="200" height="150" src="../Images/Training/shutterstock_74656324-200x150.jpg" class="attachment-cherry-thumb-s size-cherry-thumb-s wp-post-image" alt="" /></figure>
                                <h4 class="entry-title"><a href="Training-Stage-One.aspx" rel="bookmark">Training Stage One, Live Exercises</a></h4>
                                <div class="entry-content">We Teach You Every Step With Live Exercises You will be assigned a ClaimTek professional</div>
                                <div class="entry-permalink"><a href="Training-Stage-One.aspx" class="btn btn-default">read more</a></div>
                            </li>
                            <li class="related-posts_item col-xs-12 col-sm-6 col-md-3">
                                <figure class="entry-thumbnail cherry-thumb-s related-posts_thumbnail">
                                    <img width="200" height="150" src="../Images/Training/shutterstock_192063251-200x150.jpg" class="attachment-cherry-thumb-s size-cherry-thumb-s wp-post-image" alt="" /></figure>
                            ...
                            <li class="related-posts_item col-xs-12 col-sm-6 col-md-3">
                                <figure class="entry-thumbnail cherry-thumb-s related-posts_thumbnail">
                                    <img width="200" height="150" src="../Images/Training/shutterstock_184855544-200x150.jpg" class="attachment-cherry-thumb-s size-cherry-thumb-s wp-post-image" alt="" /></figure>
